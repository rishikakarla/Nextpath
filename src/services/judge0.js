...
export const LANGUAGES = [
  { id: 71, name: 'Python 3',   ext: 'py',  template: '# Write your solution here\n\n' },
  { id: 63, name: 'JavaScript', ext: 'js',  template: '// Write your solution here\n\n' },
  { id: 54, name: 'C++ 17',     ext: 'cpp', template: '#include <bits/stdc++.h>\nusing namespace std;\n\nint main() {\n    // Write your solution here\n    return 0;\n}\n' },
  { id: 62, name: 'Java',       ext: 'java',template: 'public class Main {\n    public static void main(String[] args) {\n        // Write your solution here\n    }\n}\n' },
